...
export function SpotlightCard({
  ...
  return (
    <div
      className={`relative h-full bg-background p-px before:absolute before:w-80 before:h-80 
        before:-left-40 before:-top-40 before:bg-primary  
        ...
        after:bg-secondary  after:opacity-0 after:pointer-events-none 
        after:transition-opacity after:duration-500 after:translate-x-[var(--mouse-x)] 
